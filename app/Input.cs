...
namespace EZ2Play.App
{
    public class Input : IDisposable
    {
        ...
        private const int INITIAL_DELAY = 300; // Начальная задержка в мс (чтобы случайно не пролистать мимо)
        private const int REPEAT_DELAY = 150; // Задержка повтора в мс (быстрая прокрутка после удержания)
